    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' current offset: ' + offset);

            verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' limit: ' + limit);

            verbose && _axios2.default.interceptors.request.use(function (request) {
