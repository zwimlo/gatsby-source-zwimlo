                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      verbose && console.log(_chalk2.default.magenta('zwimlo') + ' current objectType: ' + objectType);_context2.next = 4;
                            ...
                            while (1) {
                              switch (_context.prev = _context.next) {
                                case 0:
                                  ...
                                  verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' creating ' + objectType + ' with ID: ' + nodeId);verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' and gatsby node type: ' + nodeType);nodeContent = (0, _stringify2.default)(node);
                                  ...
                                  verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' nodeData ID: ' + nodeData.id);createdNode = getNode(nodeData.id);
                                ...
                                case 12:
                                  ...
                                  verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' createdNode ID: ' + createdNode.id);verbose && console.log(_chalk2.default.magentaBright('zwimlo') + ' fileNode ID: ' + fileNode.id);
